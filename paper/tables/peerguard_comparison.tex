...
\footnotesize{*Reported numbers from PeerGuard paper on GPT-4o. Our approach offers 400× lower latency at the cost of 3\% lower TPR. Complementary for tiered deployment.}
\end{table}
